...
sub startup {
    ...
    $r->any('/data/items/:id')->to('data#items', id => 'table')->name('data_items');
    $r->any('/data/facet/:name')->to('data#facet')->name('data_facet');
    $r->any('/data/facet')->to('data#facet')->name('data_facet');
